export const dictionaries = {
  en: {
    ...
    about: {
      ...
      body: "Lechner Studios is a family-run digital studio in Wattens, Tirol. Founded by Sonja Lechner with Jason Lechner as Managing Director, we design and ship digital products for SMB clients across DACH — built on craft, restraint, and an AI-native operating model. Quiet, precise, on the long horizon.",
      stat1n: "5", stat1l: "Products built",
      stat2n: "3", stat2l: "Live now",
      stat3n: "4", stat3l: "Pillars",
    },
    founder: {
      overline: "FOUNDER & MANAGING DIRECTOR",
      headline: "A solutions-oriented founder.",
      photoAlt: "Sonja Lechner — Founder, Lechner Studios",
      jasonPhotoAlt: "Jason Lechner — Managing Director, Lechner Studios",
  ...
  de: {
    ...
    founder: {
      overline: "GRÜNDERIN & GESCHÄFTSFÜHRER",
      headline: "Gründerin mit einem klaren Muster.",
      photoAlt: "Sonja Lechner — Gründerin, Lechner Studios",
      jasonPhotoAlt: "Jason Lechner — Geschäftsführer, Lechner Studios",
      sonjaName: "Sonja Lechner",
      sonjaRole: "Gründerin",
      jasonName: "Jason Lechner",
